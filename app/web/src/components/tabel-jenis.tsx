            ...
            aoColumns: [
                ...
                "sWidth": "30%" },
                {
                    ...
                    "mRender": function (data, type, full) { 
                        ...
                        "</svg></a></button>&nbsp"+
                        "<button class='space-x-3 items-center justify-center px-2 my-2 py-1 bg-red-600 border border-red-600 rounded-lg'><a class='text-sm font-sm text-white' href='/jenis-data/delete/" + full.id_jenis_ticket + "'>"+
                        "<svg class='w-5 h-5' aria-hidden='true' fill='currentColor' viewBox='0 0 20 20'>"+
